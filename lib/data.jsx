...
const CLIPS = [
  {
    id: 'c1',
    kind: 'LIVE',
    channel: 'Tagesschau 24',
    channelLogo: 'TS',
    channelColor: '#003f7c',
    title: 'Brussels summit — live reactions from Berlin',
    subtitle: 'Breaking · 14:32 CET',
    img: img('photo-1528164344705-47542687000d', 600, 1066),
    cta: 'Watch live now',
    tag: 'News',
    duration: '0:23',
    progress: 0,
    viewers: '48.2k watching',
  },
  {
    id: 'c2',
    kind: 'CLIP',
    ...
    channelLogo: 'SKY',
    channelColor: '#0072CE',
    title: 'Wirtz with a stunning curler from 25 metres',
    subtitle: 'Leverkusen 2 · Dortmund 1 · 78\'',
  ...
  },
  {
    ...
    channelLogo: 'SRF',
    channelColor: '#E30613',
    title: 'Anna roasts porcini with browned butter',
    subtitle: 'Bestes Rezept · Episode 12',
    img: img('photo-1476224203421-9ac39bcb3327', 600, 1066),
  ...
  },
  {
    ...
    channelLogo: 'arte',
    channelColor: '#E40421',
    title: 'Inside the last glassblowing workshop of Murano',
    subtitle: 'Documentary · 52 min',
    img: img('photo-1528459801416-a9e53bbf4e17', 600, 1066),
  ...
  },
  {
    ...
    channelLogo: 'P7',
    channelColor: '#E40F0F',
    title: 'Late Night: Klaas hands over the studio keys',
    subtitle: 'Joko & Klaas · gestern · 0:42',
  ...
  },
  {
    ...
    channelLogo: 'ES',
    channelColor: '#FFCC00',
    title: 'Giro d\'Italia · final climb of Stage 17',
    subtitle: 'Live · Bormio → Passo dello Stelvio',
    img: img('photo-1517649763962-0c623066013b', 600, 1066),
    cta: 'Watch live now',
    tag: 'Cycling',
    duration: '0:25',
    progress: 0,
    viewers: '31.7k watching',
  },
];
